  ...
  return (
    <div className="description">
      <div className="each-description">
        ...
        <p>
          <b>
            The number on the red, blue or yellow markers represents the number
            of networks.
          </b>
        </p>
      </div>
      <div className="each-description">
        ...
        <p>
          <b>
            You can choose one of the networks and view the available stations.
          </b>
        </p>
      </div>
      <div className="each-description">
      ...
      <div className="each-description">
        ...
        <img className="google-imgs" src={stationDetail} alt="station-detail" />
        <p>
          <b>
